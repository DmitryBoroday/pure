...
export default function Hero() {
    return (
        <section className='w-full h-full gap-4 pb-24'>
            <p className='title text-8xl lg:text-[440px] ml-6 lg:ml-0 mt-6 lg:mt-0'>pure</p>
            <h1 className='subtitle text-5xl lg:text-8xl text-end mr-6 lg:mr-32 tracking-widest mt-6 lg:mt-0'>we build<br className='lg:hidden' /> brands</h1>
            {/* <video
